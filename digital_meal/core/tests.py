...
class TestLogSecurityEvent(TestCase):
    ...
    def test_logs_basic_security_event(self):
        ...
        log_security_event(self.logger, "Suspicious activity detected", request)
    ...
    def test_logs_with_custom_level(self):
        ...
        log_security_event(
            self.logger, "Failed login attempt", request, level=logging.ERROR
        )
    ...
    def test_logs_with_custom_extra_data(self):
        ...
        log_security_event(
            self.logger, "Unauthorized access attempt", request, extra=custom_extra
        )
    ...
    def test_logs_without_session(self):
        ...
        log_security_event(self.logger, "Security event", request)
    ...
    def test_logs_with_missing_meta_fields(self):
        ...
        log_security_event(self.logger, "Event with missing data", request)
    ...
    def test_logs_with_proxy_headers(self):
        ...
        log_security_event(
            ...
            "Rate limit exceeded",
            request,
            extra={"forwarded_for": request.headers.get("x-forwarded-for")},
        )
...
class TestLogRequestsException(TestCase):
    ...
    def test_logs_with_basic_exception(self):
        ...
        log_requests_exception(
            self.logger, self.url, e, "Failed to make request: %s", str(e)
        )
    ...
    def test_logs_http_error_with_response(self):
        ...
        log_requests_exception(
            self.logger, self.url, e, "Request failed: %s", str(e), level=logging.ERROR
        )
    ...
    def test_logs_with_custom_extra_data(self):
        ...
        log_requests_exception(
            self.logger, self.url, e, "Request failed: %s", str(e), extra=custom_extra
        )
