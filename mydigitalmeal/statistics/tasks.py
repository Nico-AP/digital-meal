...
def compute_tiktok_wh_statistics_from_donation(
    ...
    Args:
        ...
        ddm_project_id: DDM project pk - used to retrieve correct donation;
    ...
    try:
        watch_history_data = get_tiktok_wh_data(participant, ddm_project_id)
