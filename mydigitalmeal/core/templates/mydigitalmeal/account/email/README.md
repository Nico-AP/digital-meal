...
<mjml>
  <mj-head>
    ...
    <mj-font name="Space Grotesk" href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300..700&display=swap"></mj-font>
    <mj-attributes>
  ...
  <mj-body background-color="#000000">
    ...
    <mj-section background-color="#212121" border-radius="5px" background-color="#0C170C" padding="30px 40px">
      <mj-column width="100%">
        <!-- Logo -->
        <mj-text color="#ffffff" font-weight="bold" align="center" font-size="32px" line-height="38px" font-family="Space Grotesk, Helvetica, Arial, sans-serif">Data Donation Module</mj-text>
        ...
        <mj-button padding="0px" background-color="#89f8c3" color="#000000" border-radius="5px" border="1px dashed solid" font-size="20px" inner-padding="10px 28px" css-class="lc-button" font-family="Space Grotesk, Helvetica, Arial, sans-serif" font-weight="bold" letter-spacing="3px">ABC123DG</mj-button>
        <mj-spacer height="30px"></mj-spacer>
