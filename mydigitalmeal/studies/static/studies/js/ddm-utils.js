...
function updateFlowButton() {
  ...
  if (allGroups.size === 0) {
    ...
    flowBtn.classList.remove('btn', 'mdm-color-btn-v2');
    flowBtn.classList.add('flow-btn', 'skip-btn');
    flowBtn.parentElement.classList.add('text-center');
    flowBtn.textContent = 'Datenspende überspringen';
    return;
  }
  ...
  if (allAnswered) {
    flowBtn.classList.remove('flow-btn', 'skip-btn');
    flowBtn.classList.add('btn', 'mdm-color-btn-v2');
